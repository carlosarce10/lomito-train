...
export { default as MuscleGroupBadge } from './components/MuscleGroupBadge/MuscleGroupBadge';
export { default as MuscleGroupBadgeList } from './components/MuscleGroupBadgeList/MuscleGroupBadgeList';
export { default as MuscleGroupFilter } from './components/MuscleGroupFilter/MuscleGroupFilter';
